...
{
    public function test_autentica_e_guarda_o_access_token_em_cache(): void
    {
        Http::fake([
    ...
    public function test_reaproveita_o_token_em_cache_sem_reautenticar(): void
    {
        Http::fake([
    ...
    public function test_forget_access_token_forca_nova_autenticacao(): void
    {
        Http::fake([
            '*oauth2/token' => Http::response($this->oauthPayload()),
            '*' => Http::response(['returnCode' => '00']),
    ...
    public function test_o_ttl_do_cache_desconta_a_margem_de_seguranca(): void
    {
    ...
    public function test_falha_de_autenticacao_lanca_excecao_de_dominio(): void
    {
    ...
    public function test_resposta_de_autenticacao_sem_access_token_e_tratada_como_falha(): void
    {
    ...
    public function test_o_log_de_falha_nao_vaza_dados_sensiveis(): void
    {
        Http::fake([
    ...
    public function test_credenciais_ausentes_lancam_erro_de_configuracao(): void
    {
    ...
    public function test_ambiente_invalido_lanca_erro_de_configuracao(): void
    {
        $this->expectException(ConfigurationException::class);
    ...
    public function test_producao_usa_as_urls_de_producao(): void
    {
    ...
    public function test_ambientes_diferentes_nao_compartilham_o_token_em_cache(): void
    {
